...
You can refer to the installation guides for [fasp-api](/docs/developer/installation/fasp-api) and [fasp-core-ui](/docs/developer/installation/fasp-core-ui) for more information on up to date versions for some of the dependencies.
:::
