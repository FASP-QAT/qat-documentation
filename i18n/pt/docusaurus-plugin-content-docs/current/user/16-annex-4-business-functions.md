...
As funções de negócios são um conjunto de recursos disponíveis para o usuário. Eles são usados ​​ao criar funções (consulte **Funções (somente administrador de aplicativos)**). Cada função tem uma ou mais funções de negócios.
Para dados de nível mestre, os verbos usados nas funções de negócios são os seguintes:

* **Lista** – Permite ao usuário ver a tabela com os dados existentes para aquele elemento de dados mestre. Se apenas “Lista X” for escolhido, o usuário poderá ver apenas “X”, mas não poderá editar ou adicionar.
...
* O usuário C tem acesso “Lista” + “Adicionar”, para que possa adicionar novas entidades e visualizar a lista de entidades.
* O usuário D tem acesso “Adicionar” + “Editar” + “Lista” (Gerenciar) que permite realizar todas as 3 ações.
