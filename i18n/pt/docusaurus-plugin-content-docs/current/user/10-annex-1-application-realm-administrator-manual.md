...
<table>
  <thead>
    <tr class="header">
      <th>
        <strong>Quais administradores?</strong>
      </th>
      <th>
        <strong>SCaptura de tela</strong>
      </th>
      <th>
        <strong>EExplicação</strong>
      </th>
    </tr>
  </thead>
  <tbody>
    <tr class="odd">
      ...
      <td>
        Este bloco exibe o número <strong> de usuários em cada função.</strong> 
        Clicar no botão suspenso exibe duas funções (“Ir para Usuário
        Gerenciamento” e “Adicionar usuário”). Ambos redirecionam os usuários para o “Aplicativo
        Mestres”&gt; “Usuário” (Veja <a href="#users">Users</a> para mais)
      </td>
    </tr>
    <tr class="even">
      <td>App</td>
      <td>
        <p>Totais de Reinos</p>
        <p>
          <img
      ...
      <td>
        Este bloco exibe o número <strong>total de regiões</strong> no
        aplicativo. Clicar no botão suspenso exibe duas funções (“Ir para
        Gerenciamento de Realm” e “Adicionar Realm”). Ambos redirecionam os usuários para os Realms
        tela, que também pode ser acessada no menu esquerdo em 
        <em>Application Masters</em>&gt; <em>Realms</em> (Consulte 
        <a href="#realm">Realm</a> para mais)
      </td>
    </tr>
    <tr class="odd">
      <td>App</td>
      ...
      <td>
        Este bloco exibe o número de idiomas <strong></strong> no aplicativo.
        Clicar no botão suspenso exibe duas funções (“Ir para Idioma
        Gestão” e “Adicionar Idioma”). Ambos redirecionam os usuários para o idioma
        tela, que também pode ser acessada no menu esquerdo em 
        <em>Application Masters</em> &gt; <em>Language</em> (Consulte 
        <a href="#language">Language</a> para mais)
      </td>
    </tr>
    <tr class="even">
      <td>Realm</td>
      ...
      <td>
        Este bloco exibe o número de países <strong></strong> no
        reino. Clicar no botão suspenso exibe duas funções: “Ir para
        Realm Country Management” leva os usuários a uma tabela de países, que é
        também acessível no menu esquerdo em <em>Realm Masters</em> &gt; 
        <em>Caís</em>. “Adicionar País do Realm” leva os usuários à tela do Realm,
        que também está acessível no menu esquerdo em 
        <em>Application Masters</em>&gt; <em>Realm,</em> onde os usuários podem mapear
        países para o reino. (Consulte <a href="#country-1">Realm Country</a> para
        mais)
      </td>
    </tr>
    <tr class="odd">
      ...
      <td>
        Este bloco exibe o número <strong> de áreas técnicas</strong> no
        reino. Clicar no botão suspenso exibe duas funções (“Ir para
        Gestão de Área Técnica” e “Adicionar Área Técnica”). Ambos redirecionam
        usuários para a tela da Área Técnica, que também pode ser acessada no canto esquerdo
        menu em <em>Application Masters</em> &gt; <em>Área Técnica</em> 
        (Veja <a href="#technical-area">Área Técnica</a> para mais)
      </td>
    </tr>
...
<tr class="even">
      ...
      <td>
        Este bloco exibe o número de regiões <strong></strong> no aplicativo.
        Clicar no botão suspenso exibe duas funções (“Ir para Região
        Gestão” e “Adicionar Região”). Ambos redirecionam os usuários para o idioma
        tela, que também pode ser acessada no menu esquerdo em 
        <em>Application Masters</em>&gt; <em>Região</em>. (Veja 
        <a href="#country-1">Realm Country</a> para mais)
      </td>
    </tr>
    <tr class="odd">
      <td>Realm</td>
      ...
      <td>
        Este bloco exibe o número <strong> de organizações</strong> no
        aplicativo. Clicar no botão suspenso exibe duas funções (“Ir para
        Gerenciamento da Organização” e “Adicionar Organização”). Ambos redirecionam os usuários para
        a tela Idioma, que também pode ser acessada no menu esquerdo em 
        <em>Application Masters</em>&gt; <em>OOrganização</em>. (Veja 
        <a href="#organization">Organização</a> para mais)
      </td>
    </tr>
    <tr class="even">
      <td>Realm</td>
      ...
      <td>
        Este bloco exibe o número <strong> de programas </strong> no aplicativo.
        Clicar no botão suspenso exibe (“Ir para Gerenciamento do Programa”,
        que redireciona os usuários para a tela Atualizar informações do programa, que também é
        acessível no menu esquerdo em <em>Gerenciamento de programas</em> &gt; 
        <em>Atualizar informações do programa</em>. (Veja 
        <a href="#program-information">Informações do programa</a> para mais)
      </td>
    </tr>
    <tr class="odd">
      <td>Realm</td>
      <td>
        <p>Programa de configuração</p>
        <p>
          <img
      ...
      <td>
        Este bloco permite que os usuários cliquem no botão suspenso para navegar até
        a tela “Programa de configuração”, que também pode ser acessada no menu esquerdo
        em <em>Gerenciamento de programas</em> &gt; <em>Programa de configuração</em>. (Veja 
        <a href="#setting-up-a-new-program">Configurando um novo programa</a> para
        mais)
      </td>
    </tr>
  </tbody>
...
Figura 192: Painel de administração em nível de aplicativo

Na captura de tela abaixo, a função atribuída é “**Administrador de nível de reino**”.

![P3585#yIS1](/img/media/image327.png)

Figura 193: Painel de administração em nível de reino

Tabela 11: blocos de administração de aplicativos e domínios

## Gerenciando dados mestre
...
### Mestres de Aplicação

#### Tradução de banco de dados

![](/img/media/image337.png)A tela de tradução do banco de dados, acessível para administradores de aplicativos, é usada para traduzir "rótulos dinâmicos" armazenados no QAT. Os rótulos dinâmicos são incluídos em listas suspensas em todo o QAT, bem como rótulos que fazem referência a outros rótulos (por exemplo, problemas da lista de problemas do QAT que fazem referência a IDs de remessa).

Para cada rótulo dinâmico, deve haver pelo menos uma tradução em inglês, conforme identificado pelo asterisco vermelho próximo a “Inglês” na figura abaixo. As traduções para os outros idiomas do software são altamente recomendadas, mas não são obrigatórias para salvar uma tradução.

Para editar uma tradução, clique duas vezes nessa célula e insira o texto desejado. Em seguida, clique no botão “Enviar”. As traduções enviadas não serão alteradas no front-end do QAT até o próximo lançamento do software.
...
Figura 195: Tela de Tradução de Etiquetas
...
3. Insira o novo país, nome de exibição do país, nome de exibição do país2 e moeda e clique no botão “Enviar”.
    1. **Nota**: O nome de exibição do país é sempre o código do país de três letras (por exemplo, Angola = AGO). O Nome de Exibição do País2 é sempre o código do país de duas letras (por exemplo, Angola = AO).

![P3684#yIS1](/img/media/image341.png)

Figura 197: Tela Adicionar País
...
Figura 198: Tela Atualizar País

#### Moeda

**Para visualizar uma lista das moedas atuais que estão em QAT:**

1. Vá para “Application Masters” e clique em “Moeda”.

2. Uma lista de moedas e seus atributos, como taxa de conversão, será mostrada abaixo:

![P3698#yIS1](/img/media/image343.png)

Figura 199: Lista de Moedas

**Para adicionar uma moeda:**

1. No canto superior direito da lista de moedas, clique no ícone “+”.

2. Uma nova tela “Adicionar Moeda” será aberta conforme mostrado abaixo.

3. Insira a nova moeda, o nome de exibição da moeda, a taxa de conversão para 1 USD e se deve sincronizar online. Após inserir todas as informações, clique no botão “Enviar”.
    1. **Nota:** A taxa de conversão para 1 USD pode ser inserida manualmente ou pode ser obtida na integração com a fonte pública online selecionando “Sim” em “Taxa de conversão online de sincronização”, que é o padrão.

![P3706#yIS1](/img/media/image344.png)

Figura 200: Tela Adicionar Moeda

**Para atualizar uma moeda existente:**

1. Para atualizar uma moeda existente, acesse a lista de moedas do Administrador do Aplicativo.
...
Figura 202: Tela Adicionar Dimensão
...
1. Vá para “Application Masters” e clique em “Language”.

2. Uma lista de idiomas será mostrada abaixo:

![P3738#yIS1](/img/media/image347.png)

Figura 203: Lista de Idiomas
...
4. **Observação:** Todos os bancos de dados e rótulos de exibição do QAT devem ser traduzidos para que um novo idioma apareça no QAT. Consulte [Tradução de banco de dados](#database-translation) e [Tradução de rótulo](#label-translation) no Apêndice 1 para obter mais informações.

![P3746#yIS1](/img/media/image348.png)

Figura 204: Tela Adicionar Idioma
...
1. Vá para “Application Masters” e clique em “Roles”.

2. Uma lista de funções será mostrada abaixo:

![P3759#yIS1](/img/media/image349.png)

Figura 205: Lista atual de funções
...
Figura 206: Tela Adicionar Função
...
Figura 207: Tela Editar Função

#### Reino

O QAT é subdividido em domínios, cada um governado por seus próprios dados mestres (incluindo catálogo de produtos, nomes de financiadores, nomes de agentes de compras, etc.). Reinos futuros poderiam ser criados para outros campos, como cadeias de fornecimento de educação, cadeias de fornecimento de agricultura, etc. Para informações e funções que podem ser executadas por um Administrador de Reino, consulte [Mestres de Nível de Reino](#realm-masters).
...
3. Insira o novo Realm, Nome de exibição do Realm, Min Guardrail para MIN MOS, Min Guardrail para MAX MOS e Max Guardrail para MAX MOS. Continue adicionando todos os valores de tolerância e restrição para o domínio e clique no botão “Enviar”.
    1. Ao adicionar um usuário ao QAT, se ele não receber um domínio, ele será automaticamente atribuído ao domínio considerado “padrão”. Só pode haver um domínio padrão por instância do QAT.

2. **Nota**: as grades de proteção MIN/MAX são os limites inferior e superior absolutos para configuração dos parâmetros MIN/MAX do programa; eles são definidos no nível do reino. Isso significa que um programa não pode ter um MIN MOS menor que o “Min guardrail for MIN MOS” ou um MAX MOS que seja maior que o “Max guardrail for MAX MOS”

![P3793#yIS1](/img/media/image353.png)

Figura 209: Tela Adicionar Realm
...
Figura 210: Mapa de países

3. A partir desta nova janela, o administrador do aplicativo pode adicionar um país clicando no botão “Adicionar linha” na parte inferior da tela. O novo país não pode já existir no domínio a ser adicionado. Para obter mais informações sobre como adicionar um país, consulte Application Masters: [Country](#country).

4. A partir desta nova janela, o administrador do aplicativo também pode tornar um país “Ativo” conforme os programas estão integrados ao QAT, ou inativo usando a caixa de seleção na última coluna.

5. Quando todas as atualizações e alterações forem feitas, clique em “Enviar”.

![P3810#yIS1](/img/media/image355.png)

Figura 211: Mapeando países para um reino
...
1. ![](/img/media/image356.png)No canto superior direito da lista de domínios, clique no ícone “+”.

2. Uma nova tela “Adicionar Usuário” será aberta conforme mostrado abaixo.
...
2. Clique no usuário que precisa ser alterado ou atualizado.

3. Atualize as informações ou controles de acesso conforme necessário e clique no botão “Atualizar”. Isso pode incluir “desabilitar” um usuário ou torná-lo “ativo”.
...
1. Vá para “Application Masters” e clique em “Usage Period”.
...
Figura 2136: Lista de Períodos de Uso
...
Figura 215: Tela de atualização de uma unidade

#### Carregar Manual do Usuário
...
1. Vá para “Application Masters” e clique em “Upload User Manual”
...
Um Reino cobre todos os programas e seus planos de abastecimento. Por exemplo, “Saúde Global” é um domínio sob o qual vários programas são geridos. Outros domínios poderiam ser criados para outros domínios, como cadeias de abastecimento da educação, cadeias de abastecimento da agricultura, etc.

#### País

**O menu País em Realm Level Masters permite que administradores de aplicativos e de reinos criem/atribuam regiões a países criados anteriormente.**

**Uma região pode ser “Nacional” para programas de uma única região ou pode ser qualquer número de regiões para programas multirregionais. A** decisão de adicionar regiões depende de como os dados de inventário e consumo serão inseridos no QAT. Note que os envios QAT são sempre Nacionais e não podem ser atribuídos a Regiões.
...
Figura 216: Mapeando regiões para um país dentro de um domínio
...
6. Selecione o status (“Ativo” ou “Desativado”) conforme mostrado na tela.
    1. **Observação:** Para adicionar múltiplas regiões, clique no botão azul “+ Adicionar linha” ou clique com o botão direito no formulário e selecione “Inserir nova linha antes” ou “Inserir nova linha depois”.
...
Figura 217: Adicionando múltiplas regiões a um país
...
Figura 218: Adicionando uma fonte de dados

**Atualizar fonte de dados**

1. > Vá para a tela “Fonte de dados”.
...
Figura 219: Tipo de fonte de dados

2. > Clique no botão azul “adicionar” no canto superior direito. Uma nova tela mostrando “Adicionar tipo de fonte de dados” será aberta.

![P3928#yIS1](/img/media/image364.png)

Figura 220: Adicionar tipo de fonte de dados
...
1. > Vá para “Realm Level Masters” e clique em “Fonte de Financiamento” para exibir a lista de fontes de financiamento atuais.

![P3943#yIS1](/img/media/image365.png)

Figura 221: Fontes de financiamento em nível de reino

4. > Clique no botão azul “+” (adicionar) abaixo do ícone do perfil.

5. > Uma nova tela “Adicionar fonte de financiamento” é aberta.

6. > Insira os dados necessários e clique no botão “Enviar” para salvar suas alterações ou “Cancelar” para fechar o formulário sem salvar.

![P3949#yIS1](/img/media/image366.png)

Figura 222: Adicionar Fonte de Financiamento
...
Figura 223: Atualizar Fonte de Financiamento

#### Fabricante

O fabricante de uma mercadoria são dados mestres que não são acessíveis/visíveis aos principais usuários do QAT. No entanto, eles fazem parte dos dados de remessa/pedido que podem/serão recebidos dos sistemas de gerenciamento de pedidos junto com atributos de mercadorias específicos do fabricante.
...
Figura 224: Fabricantes em nível de reino

2. > Clique no botão azul “+” para abrir uma nova tela “Adicionar Fabricante”.

3. > Insira os detalhes necessários.

4. > Clique em “Enviar” para salvar as alterações ou “Cancelar” para fechar o formulário sem salvar.

![P3970#yIS1](/img/media/image369.png)

Figura 225: Adicionar fabricante
...
Uma organização é um grupo de pessoas com um propósito específico, que pode ser um órgão privado ou governamental. **Aplicativo, Administradores de Realm, Administrador do Programa, Usuário do Programa e Usuário Convidado** podem listar/visualizar organizações.
...
Figura 227: Adicionar Organização
...
Figura 228: Organização de atualização

#### Tipo de organização

Os nomes das organizações podem ser personalizados de acordo com a necessidade do usuário; entretanto, para manter a padronização por meio de dados mestres, o QAT inclui um “tipo de organização” que pode ser gerenciado por um administrador de domínio.

O administrador da região atribui um tipo de organização a cada organização no QAT; por exemplo, no domínio da saúde global, o país A pode solicitar que o nome do seu programa inclua a organização Ministério da Saúde e Bem-Estar (MOHW), enquanto o país B exige que o nome do seu programa inclua Ministério da Saúde e Bem-Estar Social (MOHSW). Este nível de customização é possível no QAT, mantendo a padronização através dos mestres Organization Type. No exemplo acima, tanto o MOHW como o MOHSW receberiam o tipo de organização “Govt”, uma vez que qualquer ministério da saúde seria considerado uma entidade governamental, independentemente da denominação desse ministério da saúde em cada país.

Como o tipo de organização é um dado mestre em nível de realm, os usuários do QAT podem solicitar novos tipos de organização, se ainda não existirem, por meio da função de emissão de tickets.

![P4004#yIS1](/img/media/image373.png)

Figura 229 - Tipos de organizações no domínio da saúde global

**Adicionar tipo de organização**

1. Vá para “Realm Level Masters” e clique em “Organization Type” para exibir uma lista dos tipos de organização atuais.
...
> **Nota:** QAT não permite colocar espaço antes de iniciar o nome do tipo de organização. Espaços só serão permitidos entre palavras se o nome do tipo de organização consistir em várias palavras.

**Atualizar um tipo de organização**
...
QAT oferece suporte à padronização de dados dentro de cada domínio por meio do gerenciamento de dados mestres. Uma parte essencial dos dados mestres são os produtos. No QAT, “Produto” refere-se aos vários níveis de commodities que devem ser configurados e gerenciados por domínio: unidades de previsão, unidades de planejamento, unidades de aquisição e unidades de relatórios alternativos. Os produtos no QAT podem ser **editados/adicionados** **pelo Aplicativo ou Administradores de Realm**, exceto para as unidades de relatórios alternativas, que são gerenciadas no nível do país/programa. **Usuários de nível nacional** também podem solicitar que novas unidades de planejamento/previsão sejam adicionadas ao catálogo QAT gerando um ticket.

##### Unidade de previsão

A unidade de previsão é o equivalente QAT da unidade base do produto. Será utilizado para estimar a demanda futura, ou seja, a previsão. Por exemplo: um comprimido, um mililitro, uma camisinha. Essas unidades de previsão têm um relacionamento um-para-muitos com a unidade de planejamento, ou seja, muitas unidades de planejamento (por exemplo, TLD, frasco de 90 comprimidos, TLD, frasco de 180 comprimidos, etc.) podem estar relacionadas a uma única unidade de previsão (por exemplo, 1 comprimido TLD)
...
Figura 230: Lista de Unidades de Previsão
...
Figura 231: Atualização da Unidade de Previsão

##### Unidade de Planejamento

Por padrão, o planejamento de fornecimento no QAT é gerenciado em Unidades de Planejamento. Uma descrição da unidade de planejamento geralmente inclui uma descrição completa do produto até a embalagem primária; assim, sua nomenclatura geralmente segue o tamanho da embalagem em que ocorre a dispensação de <u></u>, ou seja, um frasco de 30 comprimidos, um blister de 10x10 cápsulas, etc. As Unidades de Planejamento também podem ter dados volumétricos atribuídos a elas para permitir um planejamento mais detalhado, mas esta tela é visualizada apenas para Administradores do Programa, e sua finalidade é mostrar dados volumétricos de cada unidade de planejamento, não para editar ou adicionar.

**Para ver e exportar a lista de todas as unidades de planejamento no catálogo em nível de região:**

1. Vá para “Mestres de Nível de Reino”.

2. Clique em “Produto” e depois em “Unidade de Planejamento”.

3. Selecione a categoria Unidade de Planejamento, a Categoria Tracer e clique em “Pesquisar”

4. Ao clicar no ícone exportar para CSV você poderá exportar todas as Unidades de Planejamento selecionadas.

![A screenshot of a computer Description automatically generated](/img/media/image379.png)

Figura 232: Lista de Unidades de Planejamento
...
Figura 233: Adicionando dados volumétricos às unidades de planejamento
...
3. Escreva o nome da nova categoria a adicionar, clique em “Adicionar” e depois em “Enviar”.

![P4100#yIS1](/img/media/image381.png)

Figura 234: Visualizando/adicionando categorias de unidades de planejamento
...
Uma descrição em nível de item da “unidade de planejamento”, incluindo atributos específicos do fornecedor/fabricante, como GTIN e preços de pedidos, que podem ser adicionados/editados manualmente por **Aplicativo** **e Administradores de Realm** ou recebidos automaticamente por meio de integração e mapeamento de unidades de planejamento QAT para um sistema de gerenciamento de pedidos de agente de compras. As unidades de compras são específicas para cada agente de compras. As unidades de aquisição não são visíveis/editáveis ​​pelos usuários em nível de país/programa.
...
2. Clique em “Unidade de Compras” e uma tabela de unidades de compras será exibida.

3. Clique no botão azul “adicionar” no canto superior direito da tela.

4. Insira todos os detalhes necessários na tela “Adicionar Unidade de Aquisição” e clique em “Enviar”.
    1. **Observação:** Os detalhes necessários incluem nome da unidade de planejamento, fabricante, fator de conversão, atributos de volume e peso, unidades por palete e por contêiner, etc.
...
Figura 237: Atualizar categoria do rastreador
...
3. Insira os dados necessários e clique no botão “Enviar”.
    1. Os mapeamentos em nível de região estão disponíveis para todos os usuários e são indicados por todos. Eles são criados e gerenciados por Administradores do Realm. O mapeamento específico do programa pode ser criado e gerenciado pelos administradores do programa. Se houver algum conflito, os mapeamentos específicos do programa terão precedência e serão usados ​​em vez dos mapeamentos em nível de região.
...
Figura 238: Tela Adicionar Área Técnica

![P4200#yIS1](/img/media/image386.png)

Figura 239 Adicionar área técnica

2. Insira os dados necessários e clique no botão “Enviar”.
    1. Caso não queira prosseguir com a criação de uma nova área técnica e não tenha clicado em enviar, clique no botão “Cancelar” e o QAT fechará o formulário sem salvar e o levará de volta à tela da Área Técnica.
...
4. Caso queira desativar ou reativar a área técnica, clique no círculo ao lado dessa opção e clique no botão “Enviar””
    1. Ao clicar no botão “Reset”, a informação da área técnica não desaparecerá, mas sim voltará ao que era antes da atualização.

![P4212#yIS1](/img/media/image387.png)

Figura 240: Atualização da Área Técnica
...
1. Na tela do Agente de Compras, vá até o canto superior direito da tela e clique no botão azul “+”.
...
4. Clique no botão “Enviar” para salvar o agente de compras.
    1. Antes de enviar, caso deseje não prosseguir com aquele agente de compras, clique no botão “Cancelar”.

![P4228#yIS1](/img/media/image388.png)

Figura 241: Adicionar agente de compras
...
5. Se desejar ativar ou desativar o agente de compras, selecione a opção correspondente na parte inferior da tela.
...
Tabela 12: Detalhes da Unidade de Planejamento do Agente de Aquisições
...
3. Uma tela intitulada “Adicionar Unidade de Planejamento do Agente de Aquisição” aparecerá.
...
6. Se você inserir informações para “MOQ”, “Unidade por palete” ou “Unidade por contêiner”, esta combinação de agente de compras/unidade de planejamento será considerada um produto *estratégico. (*Consulte a seção Dados de Remessa para saber mais sobre produtos estratégicos).
...
5. Se você inserir informações para “MOQ”, “Unidade por palete” ou “Unidade por contêiner”, esta combinação de agente de compras/unidade de planejamento será considerada um produto *estratégico. (*Consulte a seção Dados de Remessa para saber mais sobre produtos estratégicos).
...
Figura 242: Mapa da Unidade de Planejamento do Agente de Aquisições

**Para adicionar uma unidade de aquisição do agente de compras:**

1. Acesse a tela “Agente de Compras”.

2. Clique com o botão direito no agente de compras desejado ao qual deseja adicionar uma unidade de planejamento. Em seguida, selecione “Mapear Unidade de Aquisição”.
...
2. Clique com o botão direito no agente de compras desejado para o qual deseja atualizar uma(s) unidade(s) de compras. Em seguida, selecione “Mapear Unidade de Aquisição”.
...
**Observação:** Se o catálogo do agente de compras estiver integrado ao QAT, as unidades de compras e os detalhes associados no QAT refletirão automaticamente esse catálogo do agente de compras e qualquer alteração feita manualmente no QAT será substituída pela integração no momento da próxima atualização.

![P4311#yIS1](/img/media/image390.png)

Figura 243: Mapa da Unidade de Aquisições do Agente de Aquisições

#### Tipo de agente de compras
...
O administrador da região atribui um tipo de agente de compras a cada agente de compras no QAT; por exemplo, no domínio da saúde global, o país A pode solicitar que as remessas do seu programa incluam o agente de compras Joint Medical Store, enquanto o país B exige que as remessas do seu programa incluam a National Medical Store. Esse nível de customização é possível no QAT, mantendo a padronização por meio dos Type Masters do agente de compras. No exemplo acima, ambos os agentes de compras receberiam o tipo de agente de compras “Governo”.

Como o tipo de agente de compras são dados mestre em nível de região, os usuários do QAT podem solicitar novos tipos de organização, se ainda não existirem, por meio da função de emissão de tickets.

![P4320#yIS1](/img/media/image391.png)

Figura 244 – Tipos de agentes de compras no domínio da saúde global
...
> **Nota:** O QAT não permite colocar espaço antes de iniciar o nome do tipo de agente de compras. Espaços só serão permitidos entre palavras se o nome do tipo de agente de compras consistir em diversas palavras.
...
4. Clique em “Atualizar” para salvar as alterações ou “Cancelar” para fechar o formulário sem salvar.
...
2. Clique no botão azul “+Adicionar linha” para adicionar uma linha em branco
...
Figura 245: Tela do Programa de Configuração do Módulo de Planejamento de Suprimentos
...
> **Observação:** Várias áreas técnicas podem ser selecionadas usando a lista suspensa Área técnica.
>
> ![P4369#yIS1](/img/media/image397.png)

Figura 246 Configurando um programa com áreas técnicas de seleção múltipla
...
Figura 247: Adicionar dados do programa
...
**Para configurar um novo programa <u>Forecasting</u>**0F0F **siga estas etapas:**
...
Figura 248: Tela do programa de configuração do módulo de previsão

## Redefinindo a lista de problemas do QAT
...
Figura 249: Botão Redefinir QPL
...
Figura 250: Redefinir menus suspensos QPL
