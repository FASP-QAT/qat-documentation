...
<table>
  <thead>
    <tr class="header">
      <th>
        <strong> ¿Qué administradores? </strong>
      </th>
      <th>
        <strong>Scaptura de pantalla</strong>
      </th>
      <th>
        <strong>Eplicación</strong>
      </th>
    </tr>
  </thead>
  <tbody>
    <tr class="odd">
      <td>App y aplicación Reino</td>
      <td>
        <p>Usuario del programa</p>
        <p>
          <img
      ...
      <td>
        Este mosaico muestra el número <strong> de usuarios en cada función.</strong> 
        Al hacer clic en el botón desplegable se muestran dos funciones (“Ir a Usuario
        Gestión” y “Agregar Usuario”). Ambos redirigen a los usuarios a la "Aplicación
        Maestría” &gt; “Usuario” (Consulte <a href="#users">Users</a> para obtener más información)
      </td>
    </tr>
    <tr class="even">
      Aplicación <td></td>
      ...
      <td>
        Este mosaico muestra el número total de dominios <strong> </strong> en el
        aplicación. Al hacer clic en el botón desplegable se muestran dos funciones (“Ir a
        Gestión de dominio” y “Agregar dominio”). Ambos redirigen a los usuarios a Realms.
        pantalla, a la que también se puede acceder en el menú de la izquierda en 
        <em>Application Masters</em> &gt; <em>Realms</em> (Ver 
        <a href="#realm">Realm</a> para más información)
      </td>
    </tr>
    <tr class="odd">
      Aplicación <td></td>
      ...
      <td>
        Este mosaico muestra el número de idiomas <strong></strong> en la aplicación.
        Al hacer clic en el botón desplegable se muestran dos funciones (“Ir a Idioma
        Gestión” y “Agregar idioma”). Ambos redirigen a los usuarios al idioma.
        pantalla, a la que también se puede acceder en el menú de la izquierda en 
        <em>Application Masters</em> &gt; <em> Idioma</em> (Ver 
        <a href="#language">Language</a> para más información)
      </td>
    </tr>
    <tr class="even">
      <td>Reino</td>
      ...
      <td>
        Este mosaico muestra el número <strong> de países </strong> en el
        reino. Al hacer clic en el botón desplegable se muestran dos funciones: “Ir a
        Realm Country Management” lleva a los usuarios a una tabla de países, que es
        también accesible en el menú de la izquierda en <em>Realm Masters</em> &gt; 
        <em>País</em>. "Agregar país del reino" lleva a los usuarios a la pantalla del reino,
        al que también se puede acceder en el menú de la izquierda en 
        <em>Application Masters</em> &gt; <em>Realm,</em> donde los usuarios pueden mapear
        países al reino. (Consulte <a href="#country-1">País de reino</a> para
        más)
      </td>
    </tr>
    <tr class="odd">
      ...
      <td>
        Este mosaico muestra el número <strong> de áreas técnicas </strong> en el
        reino. Al hacer clic en el botón desplegable se muestran dos funciones (“Ir a
        Gestión Área Técnica” y “Agregar Área Técnica”). Ambos redireccionan
        usuarios a la pantalla Área técnica, a la que también se puede acceder en la parte izquierda
        menú en <em>Application Masters</em> &gt; <em>Área técnica</em> 
        (Consulte <a href="#technical-area">Área técnica</a> para obtener más información)
      </td>
    </tr>
...
<tr class="even">
      ...
      <td>
        Este mosaico muestra el número <strong> de regiones </strong> en la aplicación.
        Al hacer clic en el botón desplegable se muestran dos funciones (“Ir a la región
        Gestión” y “Agregar región”). Ambos redirigen a los usuarios al idioma.
        pantalla, a la que también se puede acceder en el menú de la izquierda en 
        <em>Application Masters</em> &gt; <em>Región</em>. (Ver 
        <a href="#country-1">País del reino</a> para obtener más información)
      </td>
    </tr>
    <tr class="odd">
      <td>Reino</td>
      ...
      <td>
        Este mosaico muestra el número <strong> de organizaciones</strong> en el
        aplicación. Al hacer clic en el botón desplegable se muestran dos funciones (“Ir a
        Gestión de organización” y “Agregar organización”). Ambos redirigen a los usuarios a
        la pantalla Idioma, a la que también se puede acceder en el menú de la izquierda en 
        <em>Application Masters</em> &gt; <em>Organización</em>. (Ver 
        <a href="#organization">Organización</a> para más)
      </td>
    </tr>
    <tr class="even">
      <td>Reino</td>
      ...
      <td>
        Este mosaico muestra el número <strong> de programas </strong> en la aplicación.
        Al hacer clic en el botón desplegable se muestra (“Ir a Gestión de programas”,
        que redirige a los usuarios a la pantalla Actualizar información del programa, que también es
        accesible en el menú de la izquierda en <em>Gestión de programas</em> &gt; 
        <em>Actualizar información del programa</em>. (Ver 
        <a href="#program-information">Información del programa</a> para obtener más información)
      </td>
    </tr>
    <tr class="odd">
      <td>Reino</td>
      <td>
        <p>Programa de configuración</p>
        <p>
          <img
      ...
      <td>
        Este mosaico permite a los usuarios hacer clic en el botón desplegable para navegar a
        la pantalla "Programa de configuración", a la que también se puede acceder en el menú de la izquierda
        en <em>Gestión de programas</em> &gt; <em>Programa de configuración</em>. (Ver 
        <a href="#setting-up-a-new-program">Configurando un nuevo programa</a> para
        más)
      </td>
    </tr>
  </tbody>
...
Figura 192: Panel de administración a nivel de aplicación
...
Figura 193: Panel de administración a nivel de dominio

Tabla 11: Mosaicos de administración de aplicaciones y dominios
...
### Maestros de aplicaciones

#### Traducción de bases de datos

![](/img/media/image337.png)La pantalla de traducción de la base de datos, a la que pueden acceder los administradores de aplicaciones, se utiliza para traducir "etiquetas dinámicas" que se almacenan en QAT. Las etiquetas dinámicas se incluyen en listas desplegables en todo QAT y también son etiquetas que hacen referencia a otras etiquetas (por ejemplo, problemas de la lista de problemas de QAT que hacen referencia a los ID de envío).

Para cada etiqueta dinámica, debe haber al menos una traducción al inglés, como se identifica con el asterisco rojo junto a "inglés" en la siguiente figura. Se recomiendan encarecidamente las traducciones para los otros idiomas del software, pero no son necesarias para guardar una traducción.

Para editar una traducción, haga doble clic en esa celda e ingrese el texto deseado. Luego haga clic en el botón "Enviar". Las traducciones enviadas no se modificarán en la interfaz de QAT hasta la próxima versión del software.
...
Para las etiquetas estáticas, debe haber al menos una traducción al inglés, como se identifica con el asterisco rojo junto a "inglés" en la siguiente figura. Se recomiendan encarecidamente las traducciones para los otros idiomas del software, pero no son necesarias para guardar una traducción.
...
Figura 195: Pantalla de traducción de etiquetas
...
2. El administrador de la aplicación puede ver y filtrar los países según su estado de "Activo" o Deshabilitado". Además, el usuario puede buscar un país específico utilizando la barra de búsqueda.
...
3. Ingrese el nuevo país, nombre para mostrar del país, nombre para mostrar del país2 y moneda y haga clic en el botón "Enviar".
    1. **Nota**: El nombre para mostrar del país es siempre el código de país de tres letras (por ejemplo, Angola = AGO). El nombre para mostrar del país2 es siempre el código de país de dos letras (por ejemplo, Angola = AO).

![P3684#yIS1](/img/media/image341.png)

Figura 197: Pantalla Agregar país
...
3. Actualice la información según sea necesario y luego haga clic en el botón "Actualizar". Esto puede incluir “inhabilitar” un país o hacerlo “activo”.

![P3691#yIS1](/img/media/image342.png)

Figura 198: Pantalla Actualizar país
...
Figura 199: Lista de monedas

**Para agregar una moneda:**

1. En la esquina superior derecha de la lista de monedas, haga clic en el icono "+".

2. Se abrirá una nueva pantalla "Agregar moneda" como se muestra a continuación.

3. Ingrese la nueva moneda, el nombre para mostrar de la moneda, la tasa de conversión a 1 USD y si debe sincronizarse en línea. Cuando se haya ingresado toda la información, haga clic en el botón "Enviar".
    1. **Nota:** La tasa de conversión a 1 USD se puede ingresar manualmente o se puede obtener de la integración con la fuente pública en línea seleccionando "Sí" en "Sincronizar tasa de conversión en línea", que es la opción predeterminada.

![P3706#yIS1](/img/media/image344.png)

Figura 200: Pantalla Agregar moneda

**Para actualizar una moneda existente:**

1. Para actualizar una moneda existente, vaya a la lista de monedas del Administrador de aplicaciones.
...
Figura 201: Lista de dimensiones
...
Figura 202: Pantalla Agregar dimensión
...
4. **Nota:** Todas las bases de datos de QAT y las etiquetas de visualización deben traducirse para que aparezca un nuevo idioma en QAT. Consulte [Traducción de bases de datos](#database-translation) y [Traducción de etiquetas](#label-translation) en el Apéndice 1 para obtener más información.

![P3746#yIS1](/img/media/image348.png)

Figura 204: Pantalla Agregar idioma
...
Los administradores de aplicaciones pueden crear y editar tipos de roles para toda la aplicación a medida que surge la necesidad de modificar las reglas comerciales a las que ciertos roles pueden acceder. Para obtener una lista de las funciones actuales, el acceso y las funciones asociadas, consulte el [Anexo 3: Matriz de funciones del usuario](#annenex-3-user-role-matrix).
...
Figura 205: Lista actual de roles
...
4. Para obtener una descripción y más información sobre funciones comerciales individuales, consulte el [Anexo 4: Funciones comerciales](#annenex-4-business-functions)
...
Figura 206: Pantalla Agregar rol
...
3. Ingrese el nuevo Reino, Nombre para mostrar del reino, Min Guardrail para MIN MOS, Min Guardrail para MAX MOS y Max Guardrail para MAX MOS. Continúe agregando todos los valores de tolerancia y restricción para el reino y luego haga clic en el botón "Enviar".
    1. Al agregar un usuario a QAT, si no se le asigna un dominio, se le asignará automáticamente al dominio que se considera "predeterminado". Solo puede haber un dominio predeterminado por instancia de QAT.

2. **Nota**: las barreras de seguridad MIN/MAX son los límites absolutos inferior y superior para configurar los parámetros MIN/MAX del programa; están establecidos a nivel de reino. Esto significa que un programa no puede tener un MIN MOS que sea menor que el “Guardrail mínimo para MIN MOS”, o un MAX MOS que sea mayor que el “Max guardrail para MAX MOS”.

![P3793#yIS1](/img/media/image353.png)

Figura 209: Pantalla Agregar dominio
...
3. Desde esta nueva ventana, el administrador de la aplicación puede agregar un país haciendo clic en el botón "Agregar fila" en la parte inferior de la pantalla. El nuevo país no puede existir ya en el ámbito que se va a agregar. Para obtener más información sobre cómo agregar un país, consulte Maestros de aplicaciones: [País](#país).
...
Figura 211: Mapeo de países a un reino
...
1. ![](/img/media/image356.png) En la esquina superior derecha de la lista de dominios, haga clic en el icono “+”.

2. Se abrirá una nueva pantalla "Agregar usuario" como se muestra a continuación.
...
2. Haga clic en el usuario que necesita cambiarse o actualizarse.

3. Actualice la información o los controles de acceso según sea necesario y luego haga clic en el botón “Actualizar”. Esto puede incluir "deshabilitar" a un usuario o hacerlo "activo".
...
Figura 215: Actualización de una pantalla de unidad
...
A Realm cubre todos los programas y sus planes de suministro. Por ejemplo, "Salud Global" es un ámbito bajo el cual se gestionan varios programas. Se podrían establecer otros ámbitos para otros campos, como las cadenas de suministro de educación, las cadenas de suministro de agricultura, etc.
...
Figura 216: Asignación de regiones a un país dentro de un reino
...
6. Seleccione el estado (“Activo” o “Desactivado”) como se muestra en la pantalla.
    1. **Nota:** Para agregar varias regiones, haga clic en el botón azul "+ Agregar fila", o haga clic derecho en el formulario y seleccione "Insertar nueva fila antes" o "Insertar nueva fila después".
...
Figura 217: Agregar varias regiones a un país
...
Figura 218: Agregar una fuente de datos
...
5. > Si deseas activar/desactivar esa fuente de datos, selecciona el círculo correspondiente.
...
Figura 219: Tipo de fuente de datos

2. > Haga clic en el botón azul "agregar" en la esquina superior derecha. Se abrirá una nueva pantalla que muestra "Agregar tipo de fuente de datos".

![P3928#yIS1](/img/media/image364.png)

Figura 220: Agregar tipo de fuente de datos
...
Fuente de financiamiento se refiere a la entidad que proporciona financiamiento para las adquisiciones del programa. **Los administradores de aplicaciones y dominios** pueden agregar/editar fuentes de financiación.

Para agregar una fuente de financiamiento

1. > Vaya a "Realm Level Masters" y haga clic en "Fuente de financiación" para mostrar la lista de fuentes de financiación actuales.

![P3943#yIS1](/img/media/image365.png)

Figura 221: Fuentes de financiación a nivel de reino
...
6. > Ingrese los detalles requeridos y haga clic en el botón "Enviar" para guardar los cambios o "Cancelar" para cerrar el formulario sin guardar.

![P3949#yIS1](/img/media/image366.png)

Figura 222: Agregar fuente de financiamiento
...
Figura 223: Actualizar fuente de financiamiento

#### Fabricante

El fabricante de un producto básico son datos maestros que no son accesibles/visibles para los principales usuarios de QAT. Sin embargo, son parte de los datos de envío/pedido que pueden/se recibirán de los sistemas de gestión de pedidos junto con los atributos de productos básicos específicos del fabricante.
...
Figura 224: Fabricantes a nivel de reino
...
Una organización es un grupo de personas con un propósito particular, que puede ser un organismo privado o gubernamental. **La aplicación, los administradores de dominio, el administrador del programa, el usuario del programa y el usuario invitado** pueden enumerar/ver organizaciones.
...
Figura 227: Agregar organización

**Actualizar una organización**

1. > Vaya a la pantalla Organización.

2. > Haga clic en el registro que necesita ser actualizado.

3. > Ingrese la información requerida y haga clic en el botón “Actualizar”.

![P3995#yIS1](/img/media/image372.png)

Figura 228: Organización de actualización
...
El administrador del dominio asigna un tipo de organización a cada organización en QAT; por ejemplo, en el ámbito de la salud global, el país A podría solicitar que el nombre de su programa incluya el Ministerio de Salud y Bienestar (MOHW), mientras que el país B requiere que el nombre de su programa incluya el Ministerio de Salud y Bienestar Social (MOHSW). Este nivel de personalización es posible en QAT, manteniendo la estandarización a través de los maestros de Tipo de organización. En el ejemplo anterior, tanto al MOHW como al MOHSW se les asignaría el tipo de organización “Gobierno”, ya que cualquier ministerio de salud se consideraría una entidad gubernamental, independientemente de cómo se llame ese ministerio de salud en cada país.

Como el tipo de organización son datos maestros a nivel de dominio, los usuarios de QAT pueden solicitar nuevos tipos de organización si aún no existen, a través de la función de generación de tickets.

![P4004#yIS1](/img/media/image373.png)

Figura 229 - Tipos de organizaciones en el ámbito de la salud global

**Agregar tipo de organización**

1. Vaya a "Maestros de nivel de reino" y luego haga clic en "Tipo de organización" para mostrar una lista de los tipos de organización actuales.
...
QAT admite la estandarización de datos dentro de cada ámbito a través de la gestión de datos maestros. Una pieza esencial de datos maestros son los productos. En QAT, "Producto" se refiere a los múltiples niveles de productos básicos que deben configurarse y administrarse por ámbito: unidades de pronóstico, unidades de planificación, unidades de adquisiciones y unidades de informes alternativas. Los productos en QAT pueden ser **editados/agregados** **por administradores de aplicación o de reino**, excepto las unidades de informes alternativas, que se administran a nivel de país/programa. **Los usuarios a nivel de país** también pueden solicitar que se agreguen nuevas unidades de planificación/pronóstico al catálogo QAT generando un ticket.

##### Unidad de pronóstico

La unidad de previsión es el equivalente QAT de la unidad base del producto. Se utilizará para estimar la demanda futura, es decir, el pronóstico. Por ejemplo: una tableta, un mililitro, un condón. Estas unidades de pronóstico tienen una relación de uno a muchos con la unidad de planificación, es decir, muchas unidades de planificación (por ejemplo, TLD, botella de 90 tabletas, TLD, botella de 180 tabletas, etc.) pueden relacionarse con una sola unidad de pronóstico (por ejemplo, 1 tableta TLD).
...
Figura 230: Lista de unidades de pronóstico
...
Figura 231: Actualización de la unidad de pronóstico

##### Unidad de Planificación

De forma predeterminada, la planificación de suministro en QAT se gestiona en Unidades de planificación. Una descripción de la unidad de planificación suele incluir una descripción completa del producto hasta el embalaje primario; por lo tanto, su nomenclatura generalmente sigue el tamaño del paquete en el que se produce la dispensación <u></u>, es decir, un frasco de 30 tabletas, un blister de 10x10 cápsulas, etc. Las unidades de planificación también pueden tener datos volumétricos atribuidos para permitir una planificación más detallada, pero esta pantalla es vista solo por los administradores del programa y su propósito es mostrar datos volumétricos para cada unidad de planificación, no editarlos ni agregarlos.

**Para ver y exportar la lista de todas las unidades de planificación en el catálogo a nivel de reino:**

1. Vaya a "Maestros de nivel de reino".

2. Haga clic en "Producto" y luego en "Unidad de planificación".

3. Seleccione la categoría Unidad de Planificación, la Categoría Tracer y haga clic en “Buscar”

4. Al hacer clic en el icono de exportación a CSV, podrá exportar todas las unidades de planificación seleccionadas.

![A screenshot of a computer Description automatically generated](/img/media/image379.png)

Figura 232: Lista de Unidades de Planificación
...
Figura 233: Agregar datos volumétricos a unidades de planificación

##### Categoría de unidad de planificación

A nivel de ámbito, las unidades de planificación deben agruparse en categorías amplias, como productos farmacéuticos para el VIH/SIDA, productos farmacéuticos y dispositivos de salud reproductiva (en el ámbito de la salud global) para filtrar búsquedas e informes. **Los administradores de aplicaciones y dominios** pueden agregar/editar categorías de unidades de planificación.
...
Figura 234: Ver/agregar categorías de unidades de planificación

##### Unidad de informes alternativa

Consulte [Unidades de informes alternativas](#unidades-de-informes-alternativas) para obtener más información.

##### Unidad de Adquisiciones

Una descripción a nivel de artículo de la “unidad de planificación”, que incluye atributos específicos del proveedor/fabricante, como GTIN y precios de pedidos, que **Aplicación** **y Realm Admins** pueden agregar/editar manualmente o recibir automáticamente mediante la integración y asignación de unidades de planificación QAT a un sistema de gestión de pedidos de un agente de adquisiciones. Las unidades de adquisiciones son específicas de cada agente de adquisiciones. Las unidades de adquisición no son visibles ni editables por los usuarios a nivel de país/programa.
...
4. Ingrese todos los detalles requeridos en la pantalla "Agregar unidad de adquisiciones" y haga clic en "Enviar".
    1. **Nota:** Los detalles requeridos incluyen el nombre de la unidad de planificación, el fabricante, el factor de conversión, los atributos de volumen y peso, las unidades por paleta y por contenedor, etc.
...
4. Edite la información requerida.
    1. **Nota:** Los detalles como el nombre de la unidad de planificación y el fabricante no se pueden editar.

5. Haga clic en el botón "Actualizar" para guardar los cambios.

![P4122#yIS1](/img/media/image382.png)

Figura 235: Agregar/actualizar unidad de adquisiciones

##### Categoría de rastreador

Las categorías de seguimiento son una agrupación de segundo nivel y menos amplia de tipos de productos específicos de un Reino. **Aplicación** **Los administradores y administradores de reino** pueden agregar/editar categorías de Tracer. Por ejemplo, los antirretrovirales para adultos son una categoría de seguimiento que pertenece al grupo más amplio de productos farmacéuticos contra el VIH/SIDA (categoría de unidad de planificación).

![P4127#yIS1](/img/media/image383.png)

Figura 236: Lista de categorías de trazadores
...
Figura 237: Actualizar categoría de rastreador

#### Unidad de equivalencia

La Unidad de Equivalencia permite a los usuarios gestionar datos agregados de todos los productos que son diferentes, pero relacionados. Las unidades de equivalencia se pueden utilizar en la [pantalla de pronóstico de comparación y selección] (#compare-and-select), la [pantalla de pronóstico mensual] (#pronóstico-mensual), la [pantalla de error de pronóstico (mensual)] (#error-de-pronóstico-mensual) y el [informe del plan de suministro] (#informe-plan-de-suministro).
...
3. Ingrese los detalles requeridos y haga clic en el botón "Enviar".
    1. Las asignaciones de nivel de reino están disponibles para todos los usuarios y están indicadas por todos. Estos son creados y administrados por Realm Admins. Los administradores del programa pueden crear y administrar asignaciones específicas del programa. Si hay algún conflicto, las asignaciones específicas del programa tendrán prioridad y se utilizarán en lugar de las asignaciones a nivel de dominio.
...
Figura 238: Pantalla Agregar área técnica

![P4200#yIS1](/img/media/image386.png)

Figura 239 Agregar área técnica

2. Ingrese los detalles requeridos y haga clic en el botón "Enviar".
    1. Si no desea continuar con la creación de una nueva área técnica y no ha hecho clic en enviar, haga clic en el botón "Cancelar" y QAT cerrará el formulario sin guardarlo y lo llevará de regreso a la pantalla del Área técnica.
...
4. Si desea deshabilitar o reactivar el área técnica, haga clic en el círculo al lado de esa opción y haga clic en el botón "Enviar"
    1. Al hacer clic en el botón “Restablecer”, la información en el área técnica no desaparecerá, sino que se restablecerá a lo que era antes de actualizarla.

![P4212#yIS1](/img/media/image387.png)

Figura 240: Área técnica de actualización

#### Agente de adquisiciones

Un agente de adquisiciones selecciona a los proveedores, establece condiciones de pago, investigación estratégica, selección, negociación de contratos y compra real de bienes que se envían a un programa. Los agentes de adquisiciones generalmente son contratados por la agencia que financia un envío en particular (una “Fuente de financiamiento” en QAT) y el usuario a nivel de programa los identifica al planificar un envío. Los agentes de adquisiciones son administrados por **Administradores de nivel de aplicación** y **Administradores de nivel de ámbito**.
...
1. En la pantalla del Agente de adquisiciones, vaya a la esquina superior derecha de la pantalla y haga clic en el botón azul “+”.
...
4. Haga clic en el botón "Enviar" para guardar al agente de adquisiciones.
    1. Antes de enviar, si no desea continuar con ese agente de adquisiciones, haga clic en el botón "Cancelar".

![P4228#yIS1](/img/media/image388.png)

Figura 241: Agregar agente de adquisiciones
...
5. Si desea activar o desactivar el agente de adquisiciones, seleccione la opción correspondiente en la parte inferior de la pantalla.
...
Tabla 12: Detalles de la unidad de planificación del agente de adquisiciones
...
Figura 242: Unidad de Planificación del Agente de Adquisiciones del Mapa
...
Figura 243: Unidad de Adquisiciones del Agente de Adquisiciones del Mapa

#### Tipo de agente de adquisiciones
...
Figura 244 – Tipos de agentes de adquisiciones en el ámbito de la salud global
...
> **Nota:** QAT no permite colocar espacios antes de comenzar el nombre del tipo de agente de adquisiciones. Solo se permiten espacios entre palabras si el nombre del tipo de agente de adquisiciones consta de varias palabras.
...
1. Vaya a "Realm Level Masters" y luego haga clic en "Método de pronóstico" para mostrar una lista de los métodos de pronóstico actuales.

![P4349#yIS1](/img/media/image395.png)

2. Haga clic en el botón azul “+Agregar fila” para agregar una fila en blanco.
...
Figura 245: Pantalla del programa de configuración del módulo de planificación de suministros
...
Figura 246 Configuración de un programa con áreas técnicas de selección múltiple
...
Figura 247: Agregar datos del programa
...
**Para configurar un nuevo programa <u>Forecasting</u>**0F0F **siga estos pasos:**
...
Figura 249: Botón Restablecer QPL
...
Figura 250: Restablecer menús desplegables de QPL
