...
Las funciones comerciales son un conjunto de capacidades disponibles para el usuario. Se utilizan al crear funciones (consulte **Funciones (solo administrador de aplicaciones)**). Cada rol tiene una o más funciones comerciales.
...
* **Editar**: permite al usuario actualizar o editar el elemento de datos maestros. Nota: Incluya siempre "lista" junto con "editar" o el usuario no podrá ver la pantalla para editar elementos de datos. **(NOTA: No se puede eliminar una entidad. Los usuarios solo pueden "Desactivar" entidades).**
