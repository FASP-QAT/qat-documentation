...
<table>
  <thead>
    <tr class="header">
      <th>
        <strong>Quels administrateurs ?</strong>
      </th>
      <th>
        <strong>Scapture d'écran</strong>
      </th>
      <th>
  ...
  <tbody>
    <tr class="odd">
      <td>App &amp; Royaume</td>
      <td>
        <p>Utilisateur du programme</p>
        <p>
          <img
            src="/img/media/image328.png"
            style={{width: '2.56302in', height: '0.80009in'}}
            alt="P3593C5T35#yIS1"
          />
        </p>
      </td>
      <td>
        Cette vignette affiche le nombre d'utilisateurs <strong> dans chaque rôle.</strong> 
        Cliquer sur le bouton déroulant affiche deux fonctions (« Aller à l'utilisateur
        Gestion » et « Ajouter un utilisateur »). Les deux redirigent les utilisateurs vers « Application
        Maîtres »&gt; « Utilisateur » (Voir <a href="#users">Users</a> pour en savoir plus)
      </td>
    </tr>
    <tr class="even">
      <td>App</td>
      <td>
        ...
        <p>
          <img
            src="/img/media/image329.png"
            style={{width: '2.5625in', height: '0.80311in'}}
            alt="P3598C8T35#yIS1"
          />
        </p>
      </td>
      <td>
        Cette vignette affiche le nombre total de domaines <strong></strong> dans le
        application. Cliquer sur le bouton déroulant affiche deux fonctions (« Aller à
        Gestion des domaines » et « Ajouter un domaine »). Les deux redirigent les utilisateurs vers les royaumes
        écran, qui est également accessible dans le menu de gauche sous 
        <em>Application Masters</em> &gt; <em>Realms</em> (Voir 
        <a href="#realm">Realm</a> pour en savoir plus)
      </td>
    </tr>
    <tr class="odd">
      <td>App</td>
      <td>
        ...
        <p>
          <img
            src="/img/media/image330.png"
            style={{width: '2.5in', height: '0.76772in'}}
            alt="P3603C11T35#yIS1"
          />
        </p>
      </td>
      <td>
        Cette vignette affiche le nombre de langues <strong></strong> dans l'application.
        Cliquer sur le bouton déroulant affiche deux fonctions (« Aller à Langue
        Gestion » et « Ajouter une langue »). Les deux redirigent les utilisateurs vers la langue
        écran, qui est également accessible dans le menu de gauche sous 
        <em>Application Masters</em> &gt; <em>Langage</em> (Voir 
        <a href="#language">Langage</a> pour en savoir plus)
      </td>
    </tr>
    <tr class="even">
      <td>Realm</td>
      <td>
        ...
        <p>
          <img
            src="/img/media/image331.png"
            style={{width: '2.5in', height: '0.74904in'}}
            alt="P3608C14T35#yIS1"
          />
        </p>
      </td>
      <td>
        Cette vignette affiche le nombre de pays <strong></strong> dans le
        royaume. Cliquer sur le bouton déroulant affiche deux fonctions : « Aller à
        Realm Country Management » amène les utilisateurs à un tableau de pays, qui est
        également accessible dans le menu de gauche sous <em>Realm Masters</em> &gt; 
        <em>Pays</em>. « Ajouter un pays de royaume » amène les utilisateurs à l'écran du royaume,
        qui est également accessible dans le menu de gauche sous 
        <em>Application Masters</em> &gt; <em>Realm,</em> où les utilisateurs peuvent cartographier
        pays au royaume. (Voir <a href="#country-1">Realm Country</a> pour
        plus)
      </td>
    </tr>
    <tr class="odd">
      <td>Realm</td>
      <td>
        <p>Domaine technique</p>
        <p>
          <img
            src="/img/media/image332.png"
            style={{width: '2.5in', height: '0.77634in'}}
            alt="P3613C17T35#yIS1"
          />
        </p>
      </td>
      <td>
        Cette vignette affiche le nombre <strong> de zones techniques</strong> dans le
        royaume. Cliquer sur le bouton déroulant affiche deux fonctions (« Aller à
        Gestion du domaine technique » et « Ajouter un domaine technique »). Les deux redirigent
        utilisateurs à l'écran de la zone technique, qui est également accessible à gauche
        menu sous <em>Application Masters</em> &gt; <em>Domaine technique</em> 
        (Voir le domaine technique <a href="#technical-area"></a> pour en savoir plus)
      </td>
    </tr>
...
<tr class="even">
      ...
      <td>
        ...
        <p>
          <img
            src="/img/media/image333.png"
            style={{width: '2.5in', height: '0.78472in'}}
            alt="P3618C20T35#yIS1"
          />
        </p>
      </td>
      <td>
        Cette vignette affiche le nombre <strong> de régions </strong> dans l'application.
        Cliquer sur le bouton déroulant affiche deux fonctions (« Aller à la région
        Gestion » et « Ajouter une région »). Les deux redirigent les utilisateurs vers la langue
        écran, qui est également accessible dans le menu de gauche sous 
        <em>Application Masters</em> &gt; <em>Région</em>. (Voir 
        <a href="#country-1">Realm Country</a> pour en savoir plus)
      </td>
    </tr>
    <tr class="odd">
      <td>Realm</td>
      <td>
        ...
        <p>
          <img
            src="/img/media/image334.png"
            style={{width: '2.5in', height: '0.78951in'}}
            alt="P3623C23T35#yIS1"
          />
        </p>
      </td>
      <td>
        Cette vignette affiche le nombre d'organisations <strong></strong> dans le
        application. Cliquer sur le bouton déroulant affiche deux fonctions (« Aller à
        Gestion de l'organisation » et « Ajouter une organisation »). Les deux redirigent les utilisateurs vers
        l'écran Langue, qui est également accessible dans le menu de gauche sous 
        <em>Application Masters</em> &gt; <em>Organisation</em>. (Voir 
        <a href="#organization">Organisation</a> pour en savoir plus)
      </td>
    </tr>
    <tr class="even">
      <td>Realm</td>
      <td>
        ...
        <p>
          <img
            src="/img/media/image335.png"
            style={{width: '2.5in', height: '0.76676in'}}
            alt="P3628C26T35#yIS1"
          />
        </p>
      </td>
      <td>
        Cette vignette affiche le nombre <strong> de programmes </strong> dans l'application.
        Un clic sur le bouton déroulant affiche (« Aller à la gestion des programmes »,
        qui redirige les utilisateurs vers l'écran Mettre à jour les informations sur le programme, qui est également
        accessible dans le menu de gauche sous <em>Program Management</em> &gt; 
        <em>Umettre à jour les informations sur le programme</em>. (Voir 
        <a href="#program-information">Informations sur le programme</a> pour en savoir plus)
      </td>
    </tr>
    <tr class="odd">
      <td>Realm</td>
      <td>
        <p>Programme de configuration</p>
        <p>
          <img
            src="/img/media/image336.png"
            style={{width: '2.5in', height: '0.78736in'}}
            alt="P3633C29T35#yIS1"
          />
        </p>
      </td>
      <td>
        Cette vignette permet aux utilisateurs de cliquer sur le bouton déroulant pour accéder à
        l'écran « Setup Program », qui est également accessible dans le menu de gauche
        sous <em>Gestion des programmes</em> &gt; <em>Programme de configuration</em>. (Voir 
        <a href="#setting-up-a-new-program">Configuration d'un nouveau programme</a> pour
        plus)
      </td>
    </tr>
  </tbody>
...
Alors que l'objectif du manuel d'utilisation est de guider les administrateurs de programme et les utilisateurs sur la manière de fournir un plan dans QAT, l'objectif de cette annexe est de fournir des conseils sur les fonctionnalités disponibles uniquement pour les administrateurs d'applications et de domaines. Les maîtres d'application sont principalement disponibles pour l'administrateur d'application (à quelques exceptions près), tandis que les maîtres de niveau domaine sont disponibles à la fois pour les administrateurs d'application et de domaine.
...
![P3582#yIS1](/img/media/image326.png)

Figure 192 : Tableau de bord d'administration au niveau de l'application

Dans la capture d'écran ci-dessous, le rôle attribué est « **Realm Level Admin** ».

![P3585#yIS1](/img/media/image327.png)

Figure 193 : Tableau de bord d'administration au niveau du domaine

Tableau 11 : Vilettes d'administration d'application et de domaine
...
### Maîtres d'applications

#### Traduction de base de données

![](/img/media/image337.png)L'écran de traduction de base de données, accessible aux administrateurs d'application, est utilisé pour traduire les « étiquettes dynamiques » stockées dans QAT. Les étiquettes dynamiques sont incluses dans des listes déroulantes dans QAT et sont également des étiquettes qui font référence à d'autres étiquettes (par exemple, les problèmes de la liste des problèmes QAT qui font référence aux identifiants d'expédition).

Pour chaque étiquette dynamique, il doit y avoir au moins une traduction en anglais, identifiée par l'astérisque rouge à côté de « Anglais » dans la figure ci-dessous. Les traductions pour les autres langues du logiciel sont fortement recommandées mais ne sont pas obligatoires pour enregistrer une traduction.

Pour modifier une traduction, double-cliquez sur cette cellule et saisissez le texte souhaité. Cliquez ensuite sur le bouton « Soumettre ». La ou les traductions soumises ne seront pas modifiées sur le front-end de QAT jusqu'à la prochaine version du logiciel.
...
Pour modifier une traduction, double-cliquez sur cette cellule et saisissez le texte souhaité. Cliquez ensuite sur le bouton « Soumettre ». Après avoir cliqué sur Soumettre, la traduction sera immédiatement reflétée dans QAT pour tous les utilisateurs.

![P3667#yIS1](/img/media/image339.png)

Figure 195 : Écran de traduction d'étiquette
...
![P3676#yIS1](/img/media/image340.png)

Figure 196 : Liste des pays
...
3. Entrez le nouveau pays, le nom d'affichage du pays, le nom d'affichage du pays2 et la devise et cliquez sur le bouton « Soumettre ».
    1. **Remarque** : Le nom d'affichage du pays est toujours le code du pays à trois lettres (par exemple, Angola = AGO). Country Display Name2 est toujours le code du pays à deux lettres (par exemple, Angola = AO).

![P3684#yIS1](/img/media/image341.png)

Figure 197 : Écran Ajouter un pays
...
![P3691#yIS1](/img/media/image342.png)

Figure 198 : Écran Mettre à jour le pays
...
2. Une liste des devises et de leurs attributs, tels que le taux de conversion, sera affichée comme ci-dessous :

![P3698#yIS1](/img/media/image343.png)

Figure 199 : Liste des devises

**Pour ajouter une devise :**

1. Dans le coin supérieur droit de la liste des devises, cliquez sur l'icône « + ».

2. Un nouvel écran « Ajouter une devise » s'ouvrira comme indiqué ci-dessous.

3. Entrez la nouvelle devise, le nom d'affichage de la devise, le taux de conversion à 1 USD et indiquez s'il doit être synchronisé en ligne. Lorsque toutes les informations ont été saisies, cliquez sur le bouton « Soumettre ».
    1. **Remarque :** Le taux de conversion en 1 USD peut être saisi manuellement ou il peut être obtenu à partir de l'intégration avec la source publique en ligne en sélectionnant « Oui » sur « Synchroniser le taux de conversion en ligne », qui est la valeur par défaut.

![P3706#yIS1](/img/media/image344.png)

Figure 200 : Écran Ajouter une devise

**Pour mettre à jour une devise existante :**

1. Pour mettre à jour une devise existante, accédez à la liste des devises de l'administrateur de l'application.
...
![P3719#yIS1](/img/media/image345.png)

Figure 201 : Liste des dimensions
...
3. Entrez la nouvelle dimension et cliquez sur le bouton « Soumettre ».

![P3726#yIS1](/img/media/image346.png)

Figure 202 : Écran Ajouter une dimension
...
![P3738#yIS1](/img/media/image347.png)

Figure 203 : Liste des langues
...
4. **Remarque :** Toutes les bases de données QAT et les étiquettes d'affichage doivent être traduites pour qu'une nouvelle langue apparaisse dans QAT. Veuillez consulter [Traduction de la base de données](#database-translation) et [Traduction des étiquettes](#label-translation) dans l'Annexe 1 pour plus d'informations.

![P3746#yIS1](/img/media/image348.png)

Figure 204 : Écran Ajouter une langue
...
![P3759#yIS1](/img/media/image349.png)

Figure 205 : Liste actuelle des rôles
...
![P3768#yIS1](/img/media/image350.png)

Figure 206 : Écran Ajouter un rôle
...
![P3776#yIS1](/img/media/image351.png)

Figure 207 : Écran Modifier le rôle

#### Royaume

QAT est subdivisé en domaines, chacun régi par ses propres données de base (y compris le catalogue de produits, les noms des bailleurs de fonds, les noms des agents d'approvisionnement, etc.). De futurs domaines pourraient être créés pour d'autres domaines tels que les chaînes d'approvisionnement de l'éducation, les chaînes d'approvisionnement agricoles, etc. Pour plus d'informations et les fonctions pouvant être exécutées par un administrateur de domaine, voir [Realm Level Masters] (#realm-masters).
...
![P3784#yIS1](/img/media/image352.png)

Figure 208 : Liste des royaumes
...
3. Entrez le nouveau royaume, le nom d'affichage du royaume, Min Guardrail pour MIN MOS, Min Guardrail pour MAX MOS et Max Guardrail pour MAX MOS. Continuez à ajouter toutes les valeurs de tolérance et de restriction pour le domaine, puis cliquez sur le bouton « Soumettre ».
    1. Lors de l'ajout d'un utilisateur à QAT, s'il ne se voit pas attribuer de domaine, il sera automatiquement attribué au domaine considéré comme « par défaut ». Il ne peut y avoir qu'un seul domaine par défaut par instance QAT.

2. **Remarque** : les garde-corps MIN/MAX sont les limites inférieures et supérieures absolues pour définir les paramètres MIN/MAX du programme ; ils sont définis au niveau du royaume. Cela signifie qu'un programme ne peut pas avoir un MIN MOS inférieur au « Garde-corps minimum pour MIN MOS », ou un MOS MAX supérieur au « Garde-corps maximum pour MAX MOS ».

![P3793#yIS1](/img/media/image353.png)

Figure 209 : Écran Ajouter un domaine
...
![P3804#yIS1](/img/media/image354.png)

Figure 210 : Carte des pays

3. À partir de cette nouvelle fenêtre, l'administrateur de l'application peut ajouter un pays en cliquant sur le bouton « Ajouter une ligne » en bas de l'écran. Le nouveau pays ne peut pas déjà exister dans le royaume à ajouter. Pour plus d'informations sur la façon d'ajouter un pays, voir Application Masters : [Pays](#pays).
...
5. Lorsque toutes les mises à jour et modifications ont été effectuées, cliquez sur « Soumettre ».

![P3810#yIS1](/img/media/image355.png)

Figure 211 : Cartographie des pays dans un royaume
...
1. ![](/img/media/image356.png)Dans le coin supérieur droit de la liste des domaines, cliquez sur l'icône « + ».

2. Un nouvel écran « Ajouter un utilisateur » s'ouvrira comme indiqué ci-dessous.
...
![P3836#yIS1](/img/media/image357.png)

Figure 2136 : Liste des périodes d'utilisation
...
![P3855#yIS1](/img/media/image358.png)

Figure 214 : Liste des unités
...
![P3866#yIS1](/img/media/image359.png)

Figure 215 : Mise à jour d'un écran d'unité
...
Un Royaume couvre tous les programmes et leurs plans d'approvisionnement. Par exemple, la « Santé mondiale » est un domaine dans lequel divers programmes sont gérés. D’autres domaines pourraient être créés pour d’autres domaines tels que les chaînes d’approvisionnement de l’éducation, les chaînes d’approvisionnement agricoles, etc.
...
**Une région peut être « nationale » pour les programmes monorégionaux, ou elle peut être composée de n'importe quel nombre de régions pour les programmes multirégionaux. La** décision d'ajouter des régions dépend de la manière dont les données d'inventaire et de consommation seront saisies dans QAT. Notez que les expéditions QAT sont toujours nationales et ne peuvent pas être attribuées aux régions.
...
![P3891#yIS1](/img/media/image360.png)

Figure 216 : Cartographie des régions avec un pays au sein d'un royaume
...
6. Sélectionnez l'état (« Actif » ou « Désactivé ») comme indiqué sur l'écran.
    1. **Remarque :** Pour ajouter plusieurs régions, cliquez sur le bouton bleu « + Ajouter une ligne » ou cliquez avec le bouton droit sur le formulaire et sélectionnez « Insérer une nouvelle ligne avant » ou « Insérer une nouvelle ligne après ».

7. Cliquez sur « Soumettre » pour enregistrer vos modifications ou sur « Annuler » pour fermer le formulaire sans enregistrer.

![P3898#yIS1](/img/media/image361.png)

Figure 217 : Ajout de plusieurs régions à un pays
...
![P3909#yIS1](/img/media/image362.png)

Figure 218 : Ajout d'une source de données
...
4. > Saisissez les détails mis à jour.
...
1. > Allez dans « Realm Level Masters » puis sur « Data Source Type » pour afficher le tableau ci-dessous.

![P3924#yIS1](/img/media/image363.png)

Figure 219 : Type de source de données

2. > Cliquez sur le bouton bleu « ajouter » dans le coin supérieur droit. Un nouvel écran affichant « Ajouter un type de source de données » s'ouvrira.

![P3928#yIS1](/img/media/image364.png)

Figure 220 : Ajouter un type de source de données
...
1. > Allez dans « Realm Level Masters » et cliquez sur « Funding Source » pour afficher la liste des sources de financement actuelles.

![P3943#yIS1](/img/media/image365.png)

Figure 221 : Sources de financement au niveau du domaine

4. > Cliquez sur le bouton bleu « + » (ajouter) sous l'icône de profil.

5. > Un nouvel écran « Ajouter une source de financement » s'ouvre.

6. > Entrez les informations requises et cliquez sur le bouton « Soumettre » pour enregistrer vos modifications ou « Annuler » pour fermer le formulaire sans enregistrer.

![P3949#yIS1](/img/media/image366.png)

Figure 222 : Ajouter une source de financement
...
![P3956#yIS1](/img/media/image367.png)

Figure 223 : Mise à jour de la source de financement

#### Fabricant

Le fabricant d'un produit est une donnée de base qui n'est pas accessible/visible pour les principaux utilisateurs de QAT. Cependant, ils font partie des données d'expédition/de commande qui peuvent/seront reçues des systèmes de gestion des commandes avec les attributs de produits spécifiques au fabricant.

**Pour ajouter un fabricant**

1. > Allez dans « Realm Level Masters » puis cliquez sur « Fabricant » pour afficher le tableau ci-dessous.

![P3964#yIS1](/img/media/image368.png)

Figure 224 : Fabricants au niveau du domaine

2. > Cliquez sur le bouton bleu « + » pour ouvrir un nouvel écran « Ajouter un fabricant ».

3. > Saisissez les informations requises.

4. > Cliquez sur « Soumettre » pour enregistrer les modifications ou sur « Annuler » pour fermer le formulaire sans enregistrer.

![P3970#yIS1](/img/media/image369.png)

Figure 225 : Ajouter un fabricant
...
Une organisation est un groupe de personnes ayant un objectif particulier, qui peut être un organisme privé ou gouvernemental. **L'application, les administrateurs de domaine, l'administrateur du programme, l'utilisateur du programme et l'utilisateur invité** peuvent répertorier/afficher les organisations.
...
![P3982#yIS1](/img/media/image370.png)

Figure 226 : Organisation

2. > Cliquez sur le bouton bleu « + » pour ouvrir un nouvel écran « Ajouter une organisation ».

3. > Saisissez les informations requises.

4. > Cliquez sur « Soumettre » pour enregistrer les modifications ou sur « Annuler » pour fermer le formulaire sans enregistrer.

![P3988#yIS1](/img/media/image371.png)

Figure 227 : Ajouter une organisation
...
![P3995#yIS1](/img/media/image372.png)

Figure 228 : Mettre à jour l'organisation
...
L'administrateur du domaine attribue un type d'organisation à chaque organisation dans QAT ; par exemple, dans le domaine de la santé mondiale, le pays A peut demander que le nom de son programme inclue le ministère de la Santé et du Bien-être (MOHW), tandis que le pays B exige que le nom de son programme inclue le ministère de la Santé et de la Protection sociale (MOHSW). Ce niveau de personnalisation est possible dans QAT, tout en maintenant la standardisation via les maîtres de type d'organisation. Dans l'exemple ci-dessus, le MOHW et le MOHSW se verraient attribuer le type d'organisation « Govt », car tout ministère de la Santé serait considéré comme une entité gouvernementale, quel que soit le nom de ce ministère de la Santé dans chaque pays.

Étant donné que le type d'organisation correspond à des données de base au niveau du domaine, les utilisateurs de QAT peuvent demander de nouveaux types d'organisation s'ils n'existent pas déjà, via la fonction de ticket.

![P4004#yIS1](/img/media/image373.png)

Figure 229 – Types d’organisations dans le domaine de la santé mondiale

**Ajouter un type d'organisation**

1. Allez dans « Realm Level Master », puis cliquez sur « Type d'organisation » pour afficher une liste des types d'organisation actuels.

![P4009#yIS1](/img/media/image374.png)

2. Cliquez sur le bouton bleu « + » pour ouvrir l'écran « Ajouter un type d'organisation »

3. Entrez les détails requis.

4. Cliquez sur « Soumettre » pour enregistrer les modifications ou sur « Annuler » pour fermer le formulaire sans enregistrer.

![P4014#yIS1](/img/media/image375.png)
...
**Mettre à jour un type d'organisation**
...
![P4023#yIS1](/img/media/image376.png)
...
QAT prend en charge la standardisation des données au sein de chaque domaine grâce à la gestion des données de référence. Les produits constituent un élément essentiel des données de base. Dans QAT, « Produit » fait référence aux multiples niveaux de produits qui doivent être configurés et gérés par domaine : unités de prévision, unités de planification, unités d'approvisionnement et unités de reporting alternatives. Les produits dans QAT peuvent être **modifiés/ajoutés** **par les administrateurs d'application ou de domaine**, à l'exception des unités de reporting alternatives, qui sont gérées au niveau du pays/du programme. Les **utilisateurs au niveau national** peuvent également demander l'ajout de nouvelles unités de planification/prévision au catalogue QAT en créant un ticket.

##### Unité de prévision

L'unité de prévision est l'équivalent QAT de l'unité de base du produit. Il sera utilisé pour estimer la demande future, c’est-à-dire la prévision. Par exemple : un comprimé, un millilitre, un préservatif. Ces unités de prévision ont une relation un-à-plusieurs avec l'unité de planification, c'est-à-dire que de nombreuses unités de planification (par exemple, TLD, Flacon de 90 comprimés, TLD, Flacon de 180 comprimés, etc.) peuvent être liées à une seule unité de prévision (par exemple, 1 comprimé TLD).
...
![](/img/media/image377.png)

Figure 230 : Liste des unités de prévision
...
![P4052#yIS1](/img/media/image378.png)

Figure 231 : Mettre à jour l'unité de prévision

##### Unité de planification

Par défaut, la planification des approvisionnements dans QAT est gérée en unités de planification. Une description d'unité de planification comprend généralement une description complète du produit jusqu'à l'emballage primaire ; ainsi, sa nomenclature suit généralement la taille de l'emballage dans lequel se produit la distribution <u></u>, c'est-à-dire un flacon de 30 comprimés, un blister de 10 x 10 gélules, etc. Les unités de planification peuvent également se voir attribuer des données volumétriques pour permettre une planification plus détaillée, mais cet écran est visible uniquement pour les administrateurs de programme et son objectif est d'afficher les données volumétriques pour chaque unité de planification, et non de les modifier ou d'en ajouter.
...
4. En cliquant sur l'icône d'exportation vers CSV, vous pouvez exporter toutes les unités de planification sélectionnées.

![A screenshot of a computer Description automatically generated](/img/media/image379.png)

Figure 232 : Liste des unités de planification
...
Comme mentionné dans la section Unité de planification, les unités de planification peuvent se voir attribuer des volumétriques pour permettre une planification plus détaillée. Cependant, cet écran est accessible uniquement aux administrateurs du programme et son objectif est d'afficher les données volumétriques pour chaque unité de planification, et non de les modifier ou d'en ajouter. **Application** **et** **Les administrateurs de domaine peuvent** ajouter/modifier les données volumétriques de l'unité de planification dans l'écran de l'unité de planification.

**Pour ajouter des données volumétriques aux unités de planification :**

**Les administrateurs d'applications et de domaines peuvent** ajouter/modifier les données volumétriques de l'unité de planification à partir de l'écran de l'unité de planification.
...
![P4090#yIS1](/img/media/image380.png)

Figure 233 : Ajout de données volumétriques aux unités de planification
...
![P4100#yIS1](/img/media/image381.png)

Figure 234 : Affichage/ajout de catégories d'unités de planification
...
4. Entrez tous les détails requis sur l'écran « Ajouter une unité d'approvisionnement » et cliquez sur « Soumettre ».
    1. **Remarque :** Les détails requis incluent le nom de l'unité de planification, le fabricant, le facteur de conversion, les attributs de volume et de poids, les unités par palette et par conteneur, etc.
...
![P4141#yIS1](/img/media/image384.png)

Figure 237 : Catégorie du traceur de mise à jour
...
![P4198#yIS1](/img/media/image385.png)

Figure 238 : Écran Ajouter une zone technique

![P4200#yIS1](/img/media/image386.png)

Figure 239 Ajouter une zone technique

2. Entrez les informations requises et cliquez sur le bouton « Soumettre ».
    1. Si vous ne souhaitez pas procéder à la création d'un nouveau domaine technique et que vous n'avez pas cliqué sur Soumettre, cliquez sur le bouton « Annuler » et QAT fermera le formulaire sans enregistrer et vous ramènera à l'écran du domaine technique.
...
3. Entrez les modifications souhaitées dans la zone technique et cliquez sur le bouton « Soumettre ».
...
4. Si vous souhaitez désactiver ou réactiver la zone technique, cliquez sur le cercle à côté de cette option et cliquez sur le bouton « Soumettre » »
    1. En cliquant sur le bouton « Réinitialiser », les informations de la zone technique ne disparaîtront pas, mais seront réinitialisées à ce qu'elles étaient avant leur mise à jour.

![P4212#yIS1](/img/media/image387.png)

Figure 240 : Mettre à jour la zone technique
...
1. Sur l’écran de l’agent d’approvisionnement, allez dans le coin supérieur droit de l’écran et cliquez sur le bouton bleu « + ».
...
4. Cliquez sur le bouton « Soumettre » pour enregistrer l'agent d'approvisionnement.
    1. Avant de soumettre, si vous ne souhaitez pas procéder avec cet agent d'approvisionnement, cliquez sur le bouton « Annuler ».

![P4228#yIS1](/img/media/image388.png)

Figure 241 : Ajouter un agent d'approvisionnement
...
5. Si vous souhaitez activer ou désactiver l'agent d'approvisionnement, sélectionnez l'option correspondante en bas de l'écran.
...
|                         |                                                                                                                                                                                                                                                                       |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Unité de planification** | L'unité de planification est le produit à planifier dans QAT. Il s'agit d'un produit avec une description complète jusqu'au conditionnement primaire (ex : flacon de 30 comprimés, blister 10x10, etc.).                                                                                       |
| **Unité des achats** | L'unité d'approvisionnement est une description de niveau supérieur de l'unité de planification qui comprend des attributs spécifiques au fournisseur tels que les coûts et les GTIN.                                                                                                                          |
| **Code UGS** | Le code d'unité de gestion des stocks (SKU) est une fonctionnalité utilisée pour identifier des produits spécifiques et souvent imprimée sur les étiquettes des produits et des caisses. Le code SKU doit correspondre à ce qui figure dans le catalogue de l’agent d’approvisionnement.                                                            |
| **Prix catalogue** | Prix ​​inclus dans le catalogue de l’agent d’approvisionnement.                                                                                                                                                                                                                    |
| **MOQ** | La quantité minimum de commande fait référence au montant minimum qui peut être commandé auprès d'un agent d'approvisionnement pour cette unité de planification spécifique.                                                                                                                                     |
| **Unités par conteneur** | Nombre maximum d'unités pour une unité de planification pouvant tenir dans un conteneur utilisé par l'agent d'approvisionnement pour expédier le produit à un programme.                                                                                                                           |
| **Unités par palette** | Unités par palette définit le nombre d'unités de planification pouvant être emballées sur une palette standard, par dimension de palette. Unités par palette décrit les articles individuels sur une palette en « unités » uniques qui peuvent être facilement déplacées avec un transpalette ou un chariot élévateur. |
| **Volume** | Le volume de l'unité de planification.                                                                                                                                                                                                                                      |
| **Poids** | Le poids de l'unité de planification.                                                                                                                                                                                                                                      |
| **GTIN** | Le Global Trade Item Number est un identifiant pour les articles commerciaux, développé par GS1. Ces identifiants sont utilisés pour rechercher des informations sur les produits dans une base de données pouvant appartenir à un fabricant.                                                                           |

Tableau 12 : Détails de l'unité de planification de l'agent d'approvisionnement
...
![P4290#yIS1](/img/media/image389.png)

Figure 242 : Carte de l'unité de planification de l'agent d'approvisionnement
...
**Remarque :** Si le catalogue de l'agent d'approvisionnement est intégré à QAT, les unités d'approvisionnement et les détails associés dans QAT refléteront automatiquement le catalogue de cet agent d'approvisionnement et toute modification que vous apportez manuellement dans QAT sera remplacée par l'intégration au moment de la prochaine mise à jour.

![P4311#yIS1](/img/media/image390.png)

Figure 243 : Carte de l'unité d'approvisionnement de l'agent d'approvisionnement

#### Type d'agent d'approvisionnement

Les agents d'approvisionnement peuvent être personnalisés en fonction des besoins du programme ; cependant, afin de maintenir la standardisation grâce aux données de base, QAT inclut un « type d'agent d'approvisionnement » qui peut être géré par un administrateur de domaine.

L'administrateur du domaine attribue un type d'agent d'approvisionnement à chaque agent d'approvisionnement dans QAT ; par exemple, dans le domaine de la santé mondiale, le pays A peut demander que ses expéditions de programme incluent l'agent d'approvisionnement Joint Medical Store, tandis que le pays B exige que ses expéditions de programme incluent National Medical Store. Ce niveau de personnalisation est possible dans QAT, tout en maintenant la standardisation via les maîtres de types d'agent d'approvisionnement. Dans l’exemple ci-dessus, les deux agents d’approvisionnement se verraient attribuer le type d’agent d’approvisionnement « Gouvernement ».
...
![P4320#yIS1](/img/media/image391.png)

Figure 244 – Types d’agents d’approvisionnement dans le domaine de la santé mondiale

**Ajouter un type d'agent d'approvisionnement**

1. Allez dans « Realm Level Masters » puis cliquez sur « Procurement Agent Type » pour afficher une liste des types d'organisations actuels.

![P4325#yIS1](/img/media/image392.png)

2. Cliquez sur le bouton bleu « + » pour ouvrir l'écran « Ajouter un type d'agent d'approvisionnement »

3. Entrez les détails requis.

4. Cliquez sur « Soumettre » pour enregistrer les modifications ou sur « Annuler » pour fermer le formulaire sans enregistrer.

![P4330#yIS1](/img/media/image393.png)
...
![P4339#yIS1](/img/media/image394.png)

3. Entrez les détails requis.

4. Cliquez sur « Mettre à jour » pour enregistrer les modifications ou sur « Annuler » pour fermer le formulaire sans enregistrer.
...
1. Accédez à « Realm Level Masters », puis cliquez sur « Méthode de prévision » pour afficher une liste des méthodes de prévision actuelles.

![P4349#yIS1](/img/media/image395.png)

2. Cliquez sur le bouton bleu « +Ajouter une ligne » pour ajouter une ligne vide
...
![P4363#yIS1](/img/media/image396.png)

Figure 245 : Écran du programme de configuration du module de planification des approvisionnements

3. Remplissez la section Royaume et cliquez sur « Suivant ». Si l'utilisateur n'a accès qu'à un seul domaine, celui-ci sera automatiquement sélectionné pour l'utilisateur.

4. Ensuite, sélectionnez le pays auquel le programme est destiné et cliquez sur « Suivant ». Si le pays n'est pas répertorié, l'administrateur de l'application devra ajouter ou activer ce pays spécifique pour le domaine.

5. Sélectionnez le(s) domaine(s) technique(s) auquel le programme est destiné et cliquez sur « Suivant ». Si le domaine technique n'est pas répertorié, l'administrateur de l'application devra ajouter ou activer ce domaine technique pour le domaine.

> **Remarque :** Plusieurs domaines techniques peuvent être sélectionnés à l'aide de la liste déroulante Domaine technique.
>
> ![P4369#yIS1](/img/media/image397.png)

Figure 246 Mise en place d'un programme avec des domaines techniques à sélection multiple

6. Sélectionnez l'organisation à laquelle le programme est destiné et cliquez sur « Suivant ». Si l'organisation n'est pas répertoriée, l'administrateur de l'application devra ajouter ou activer cette organisation pour le domaine.

7. Sélectionnez la ou les régions auxquelles le programme est destiné et cliquez sur « Suivant ». Si une région dont l'utilisateur a besoin n'est pas répertoriée, l'administrateur de l'application devra ajouter ou activer cette région pour le domaine. Cette étape permet d'effectuer une ou plusieurs sélections.

8. L'étape 6 est l'endroit où l'utilisateur fournira les données du programme. Remplissez tous les détails requis.

![](/img/media/image398.png)

Figure 247 : Ajouter des données de programme

9. La dernière étape de configuration du programme consiste à ajouter la ou les unités de planification. Tous les champs de cette étape sont obligatoires pour continuer. Tout champ laissé vide sera surligné en jaune jusqu'à ce qu'il soit rempli.

10. Cliquez sur « Soumettre ».

**Pour configurer un nouveau programme <u>Forecasting</u>**0F0F **suivez ces étapes :**

1. Accédez à « Gestion du programme » dans le menu de la barre latérale et sélectionnez « Mettre à jour les informations sur le programme ».

2. Cliquez sur l'icône bleue « + » dans le coin supérieur droit de l'écran.

3. Remplissez les champs obligatoires pour Pays, Domaine technique, Organisation, Région, Programme de prévision, Gestionnaire de programme et les paramètres de la version 1 (Début de la prévision, Période de prévision, Fin de la prévision). Les [Paramètres de version] (#version-settings) peuvent être mis à jour à tout moment par les administrateurs du programme.
...
![P4387#yIS1](/img/media/image399.png)

Figure 248 : Écran du programme de configuration du module de prévision

## Réinitialisation de la liste des problèmes QAT
...
![A screenshot of a computer Description automatically generated](/img/media/image400.png)

Figure 249 : Bouton de réinitialisation du QPL

3. > Choisissez le type de version, l'état et le programme qui doivent être réinitialisés.

![A screenshot of a computer Description automatically generated](/img/media/image401.png)

Figure 250 : Réinitialiser les listes déroulantes QPL
